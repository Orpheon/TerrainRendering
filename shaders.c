...
// Source: https://github.com/rikusalminen/triangles/blob/master/src/shader.c
...
unsigned shader_load(const char *vert, const char *frag)
{
    GLenum types[] = {
        GL_VERTEX_SHADER,
        GL_FRAGMENT_SHADER
    ...
    const char *filenames[] = { vert, frag };
